		...
		<section className={`sm:p-0 sm:pb-[72px] p-6 w-full mx-auto ${!userDetails?._id && 'bg-white dark:bg-bgcDark'} relative`}>
			<div className="container !px-0">
				<div className={`flex items-center justify-between relative self-stretch w-full mb-6 sm:mb-12`}>
					<h2
						className={`font-medium text-text dark:text-textDark sm:text-[40px] text-2xl leading-10 font-['Rubik',Helvetica]`}>
						Top Stories
					</h2>
					{!isVertical ? (
				...
				<div className={`flex flex-col w-full items-start gap-12`}>
					<div
						className={`hidden sm:flex items-center gap-[30px] relative w-full  ${isVertical && "flex-col"}`}>
